    ...
    <div className="col-md-3 col-lg-2 sidebar-offcanvas pl-0 h-auto" id="sidebar" role="navigation" style={{ backgroundColor: '#2a52be' }}>
      <ul className="nav flex-column sticky-top pl-0 pt-5 p-3 mt-3 h-100">
        ...
        <li className="nav-item mb-2">
          <Link className="nav-link text-secondary text-light" to="/admin/product-owner">
        ...
        <li className="nav-item mb-2">
          <Link className="nav-link text-secondary text-light" to="/admin/developer">
            <span className="ml-3">Developer</span>
          </Link>
        </li>
        <li className="nav-item mb-2">
          <Link className="nav-link text-secondary text-light" to="/admin/freelancer">
            <span className="ml-3">Freelancer</span>
          </Link>
        </li>
        <li className="nav-item mb-2">
          <Link className="nav-link text-secondary text-light" to="/admin/client">
            <span className="ml-3">Client</span>
          </Link>
        </li>
        <li className="nav-item mb-2">
          <Link className="nav-link text-secondary text-light" to="/admin/payment">
