...
function Row(props) {
  const token = '12|GKUgS6DUjwmCYsa7ojjXx0crJtskDJwoBaeDDDsS';
  const { row } = props;
          ...
          >
            <Stack spacing={2}>
              <FormControl>
                ...
                <Input value={title} onChange={handleTitleChange} autoFocus required disabled />
              </FormControl>
              <FormControl>
              ...
              <FormControl>
                ...
                <Input value={startDate} onChange={handleStartDateChange} autoFocus required type="date"  disabled/>
              </FormControl>
              <FormControl>
                <FormLabel>End</FormLabel>
                <Input value={endDate} onChange={handleEndDateChange} autoFocus required type="date" disabled/>
              </FormControl>
              
              <FormControl>
                <FormLabel>Description</FormLabel>
                <TextareaAutosize minRows={3} disabled value={description} onChange={handleDescriptionChange} autoFocus required />
              </FormControl>
